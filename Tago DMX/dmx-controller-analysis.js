...
async function startAnalysis(context) {
  try {
    ...
    if (!command) {
      console.log("No command provided to analysis. This is normal when running manually.");
      console.log("To test the analysis, provide a command via action trigger or environment variable.");
      return;
    }
