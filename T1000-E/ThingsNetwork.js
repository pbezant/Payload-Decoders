// Extended TTN Payload Formatter for SenseCAP T1000-A
// Fully supports GNSS, BLE, Wi-Fi, Motion, Temperature, Light, SOS, Fall, Button Press, etc.
...
function decodeUplink(input) {
  ...
  // ==== Full Decoder Logic Below (from Seeed Studio) ====
